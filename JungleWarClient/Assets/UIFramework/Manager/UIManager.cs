...
public class UIManager :BaseManager{
    ...
    public void ShowMeeageSync(string str)
    {
        if (messagePanel!=null)
        {
            messagePanel.ShowMessageSync(str);
        }
    ...
    private BasePanel GetPanel(UIPanelType panelType)
    {
        ...
        //BasePanel panel;
        //panelDict.TryGetValue(panelType, out panel);//TODO0
        ...
        if (panel == null)
        {
            ...
            instPanel.GetComponent<BasePanel>().SetGameFacade = facade;
